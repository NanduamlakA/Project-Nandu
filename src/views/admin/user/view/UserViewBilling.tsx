...
import UserSubscriptionDialog from 'src/views/admin/user/view/UserSubscriptionDialog';
                  ...
                  <Table size="small" sx={{ width: '95%' }}>
                    ...
                    >
                      <TableRow>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>Reab</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>100 Water Plant Avenue, Building 1303 Wake Island</Typography>
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
              ...
              <form>
                <Grid container spacing={6}>
                  <Grid item xs={12} sm={6}>
                    <CustomTextField fullWidth defaultValue="Reab" label="Company Name" placeholder="Reab" />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <CustomTextField
                      fullWidth
                  ...
                  <Grid item xs={12} sm={6}>
                    <CustomTextField fullWidth label="Contact" placeholder="723-348-2344" defaultValue="+1(609) 933-44-22" />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <CustomTextField fullWidth type="number" label="Zip Code" placeholder="99950" defaultValue="403114" />
                  </Grid>
                </Grid>
              </form>
            </DialogContent>
