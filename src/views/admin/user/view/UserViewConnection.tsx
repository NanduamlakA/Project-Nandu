    ...
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <CardContent>
            <Typography sx={{ mb: 6, color: 'text.secondary' }}>Display content from your connected accounts on your site</Typography>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <CardContent>
            <Typography sx={{ mb: 6, color: 'text.secondary' }}>Display content from social accounts on your site</Typography>
            ...
            {socialAccountsArr.map((account) => {
              return (
                ...
                >
                  ...
                  <Button variant="tonal" sx={{ p: 2, minWidth: 38 }} color={account.isConnected ? 'error' : 'secondary'}>
