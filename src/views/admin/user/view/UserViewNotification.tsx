...
const UserViewNotification = () => {
  return (
    <Card>
      ...
      <CardContent>
        <Typography sx={{ mb: 6, color: 'text.secondary' }}>You will receive notification for the below selected items.</Typography>
        <TableContainer
          sx={{
        ...
        >
          <Table sx={{ minWidth: 500 }}>
            ...
            >
              ...
              <TableRow>
                <TableCell sx={{ fontSize: (theme) => theme.typography.body1.fontSize }}>A new browser used to sign in</TableCell>
                <TableCell align="center" sx={{ pt: '0 !important', pb: '0 !important' }}>
                  <Checkbox defaultChecked />
                </TableCell>
                <TableCell align="center" sx={{ pt: '0 !important', pb: '0 !important' }}>
              ...
              <TableRow sx={{ '& .MuiTableCell-root': { border: 0 } }}>
                <TableCell sx={{ fontSize: (theme) => theme.typography.body1.fontSize }}>A new device is linked</TableCell>
                <TableCell align="center" sx={{ pt: '0 !important', pb: '0 !important' }}>
                  <Checkbox defaultChecked />
                </TableCell>
                <TableCell align="center" sx={{ pt: '0 !important', pb: '0 !important' }}>
